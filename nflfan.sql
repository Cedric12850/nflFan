...
INSERT INTO `team_teams` (`id`, `name`, `town`, `thumbnail`, `founded`, `stadium_id`, `division_id`, `colorOne`, `colorTwo`, `owner`) VALUES
(1, 'Chiefs', 'Kansas City', 'logo/KC.webp', '1960-01-01', NULL, 1, '#E31837', '#FFB81C', 'Clark Hunt'),
(2, 'Broncos', 'Denver', 'logo/Broncos.webp', '1960-01-01', NULL, 1, '#FB4F14', '#002244', NULL),
(3, 'Raiders', 'Los Angeles', 'logo/Raiders.webp', '1960-01-01', NULL, 1, '#000000', '#A5ACAF', NULL),
(4, 'Chargers', 'Los Angeles', 'logo/Chargers.webp', '1960-01-01', NULL, 1, '#0080C6', '#FFC20E', NULL),
(5, 'Bills', 'Buffalo', 'logo/Bills.webp', '1960-01-01', NULL, 2, '#00338D', '#C60C30', NULL),
(6, 'Dolphins', 'Miami', 'logo/Dolphins.webp', '1966-01-01', NULL, 2, '#008E97', '#FC4C02', NULL),
(7, 'Patriots', 'New England', 'logo/Patriots.webp', '1960-01-01', NULL, 2, '#002244', '#C60C30', NULL),
(8, 'Jets', 'New York', 'logo/Jets.webp', '1960-01-01', NULL, 2, '#125740', '#000000', NULL),
(9, 'Ravens', 'Baltimore', 'logo/Ravens.webp', '1996-01-01', NULL, 3, '#241773', '#9E7C0C', 'Steve Bisciotti'),
(10, 'Bengals', 'Cincinnati', 'logo/Bengals.webp', '1968-01-01', NULL, 3, '#fb4f14', '#000000', NULL),
(11, 'Browns', 'Cleveland', 'logo/Browns.webp', '1946-01-01', NULL, 3, '#311D00', '#ff3c00', NULL),
(12, 'Steelers', 'Pittsburgh', 'logo/Steelers.webp', '1933-01-01', NULL, 3, '#FFB612', '#101820', NULL),
(13, 'Texans', 'Houston', 'logo/Texans.webp', '2002-01-01', NULL, 4, '#03202f', '#A71930', NULL),
(14, 'Colts', 'Indianapolis', 'logo/Colts.webp', '1953-01-01', NULL, 4, '#002C5F', '#A2AAAD', NULL),
(15, 'Jaguars', 'Jacksonville', 'logo/Jaguars.webp', '1995-01-01', NULL, 4, '#101820', '#D7A22A', NULL),
(16, 'Titans', 'Tennessee', 'logo/Titans.webp', '1960-01-01', NULL, 4, '#0C2340', '#4B92DB', NULL),
(17, 'Cowboys', 'Dallas', 'logo/Cowboys.webp', '1960-01-01', NULL, 8, '#003594', '#869397', NULL),
(18, 'Giants', 'New York', 'logo/Giants.webp', '1925-01-01', NULL, 8, '#0B2265', '#a71930', NULL),
(19, 'Eagles', 'Philadelphie', 'logo/Eagles.webp', '1933-01-01', NULL, 8, '#004C54', '#A5ACAF', NULL),
(20, 'Commanders', 'Washington', 'logo/Commanders.webp', '1932-01-01', NULL, 8, '#5A1414', '#FFB612', NULL),
(21, 'Bears', 'Chicago', 'logo/Bears.webp', '1920-01-01', NULL, 5, '#0B162A', '#c83803', NULL),
(22, 'Lions', 'Detroit', 'logo/Lions.webp', '1930-01-01', NULL, 5, '#0076b6', '#B0B7BC', NULL),
(23, 'Packers', 'Green Bay', 'logo/Packers.webp', '1921-01-01', NULL, 5, '#203731', '#FFB612', NULL),
(24, 'Vickings', 'Minnesota', 'logo/Vickings.webp', '1961-01-01', NULL, 5, '#4F2683', '#FFC62F', NULL),
(25, 'Falcons', 'Atlanta', 'logo/Falcons.webp', '1966-01-01', NULL, 6, '#a71930', '#000000', NULL),
(26, 'Panthers', 'Carolina', 'logo/Panthers.webp', '1995-01-01', NULL, 6, '#0085CA', '#101820', NULL),
(27, 'Saints', 'New Orleans', 'logo/Saints.webp', '1967-01-01', NULL, 6, '#D3BC8D', '#101820', NULL),
(28, 'Buccaneers', 'Tampa Bay', 'logo/Buccaneers.webp', '1976-01-01', NULL, 6, '#D50A0A', '#FF7900', NULL),
(29, 'Cardinals', 'Arizona', 'logo/Cardinals.webp', '1920-01-01', NULL, 7, '#97233F', '#000000', NULL),
(30, 'Rams', 'Los Angeles', 'logo/Rams.webp', '1937-01-01', NULL, 7, '#003594', '#ffa300', NULL),
(31, '49ers', 'San Francisco', 'logo/49ers.webp', '1946-01-01', NULL, 7, '#AA0000', '#B3995D', NULL),
(32, 'Seahawks', 'Seattle', 'logo/Seahawks.webp', '1976-01-01', NULL, 7, '#002244', '#69BE28', NULL);
