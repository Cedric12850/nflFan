...
# Inline pour afficher les matchs associés à chaque semaine dans l'admin
class PlayGameInline(admin.TabularInline):
    model = PlayGame
    extra = 0  # N'afficher aucune ligne vide par défaut
...
class SeasonAdmin(admin.ModelAdmin):
    ...
    inlines = [PlayGameInline]  # Affiche les matchs sous chaque semaine dans l'admin
