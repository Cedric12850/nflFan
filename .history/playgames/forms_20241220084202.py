...
class PlaygamesForm(forms.ModelForm):
    ...
    def __init__(self, *args, **kwargs):
        super().__init__(*args, **kwargs)
        self.fields['team_local'].queryset = Team.objects.all()  # Ajouter un queryset valide
        self.fields['team_visitor'].queryset = Team.objects.all()  # Ajouter un queryset valide