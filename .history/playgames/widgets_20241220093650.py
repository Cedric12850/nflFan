    ...
    def render_option(self, selected_choices, option_value, option_label):
        ...
        if option_value:
            ...
            if team and team.thumbnail:
                ...
                # Modifie l'option pour inclure l'image et le label
                option = f'<option value="{option_value}" {option}>' \
                         f'<img src="{image_url}" alt="{option_label}" style="width: 20px; height: 20px; margin-right: 10px;">' \
