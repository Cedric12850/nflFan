...
class teamDetailView(DetailView):
    ...
    def get_context_data(self, **kwargs):
        ...
        if classement:
            # variable pour ajout du suffixe a la position
            sorted_teams_suffix = []
            for i, team_data in enumerate(classement["sorted_teams", start=1]):
                
            context["rank"] = classement["rank"]    # position de l'équipe dans la divison
            context["sorted_teams"] = classement["sorted_teams"]
