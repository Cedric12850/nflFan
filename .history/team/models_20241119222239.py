...
class Teams(models.Model):
    ...
    thumbnail = models.ImageField(upload_to="thumbnaillogo")  #si on ne veut pas que l'image soit obligatoire il faut ajoutter dans les param (blank=True, null=True)
