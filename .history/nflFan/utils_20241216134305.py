...
def get_current_week_dates():
    ...
    # Trouver le jour de la semaine (0 = Lundi, 6 = Dimanche)
    # La semaine commence le jeudi
    days_to_thursday = (3 - today.weekday()) % 7  # Jour de la semaine en Python (lundi=0, dimanche=6)
    thursday = today + timedelta(days=days_to_thursday)

    # La semaine se termine le mardi suivant
    tuesday = thursday + timedelta(days=5)

    return thursday, tuesday
