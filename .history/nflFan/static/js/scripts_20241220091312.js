...
$(document).ready(function () {
    $('.team-select').select2({
        width: '100%', // Adapter la largeur à celle du conteneur
        dropdownCssClass: 'form-select', // Appliquer les styles du dropdown Bootstrap
        selectionCssClass: 'form-select', // Appliquer les styles au champ sélectionné
